    ...
    <div className='Hero pt-36 container'>
          <div className='flex flex-wrap '>
            <div className='w-full self-center px-4 lg:w-1/2 '>
              ...
              <h2 className='font-medium text-slate-400 text-lg mb-10 lg:text-2xl ' > <Typed strings={['Programmer & ']} typeSpeed={120} backSpeed={130} loop/>  <span className='text-dark'> Pelajar</span> </h2>
