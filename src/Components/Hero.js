    ...
    <div className='Hero pt-36 container'>
          <div className='flex flex-wrap '>
            <div className='w-full self-center px-4 lg:w-1/2'>
              <h1 className='text-base font-semibold text-teal-500 md:text-xl lg:text-2xl md:text-xl '>Halo Semua 🖐️ . Saya 
              <span className='block font-bold text-dark text-4xl  mt-1 lg:text-5xl' >Dede <span className='text-teal-600'>sya</span>rifudin</span> 
               </h1>
              <h2 className='font-medium text-slate-400 text-lg mb-10 lg:text-2xl ' > Programmer & <span className='text-dark'> Pelajar</span> </h2>
